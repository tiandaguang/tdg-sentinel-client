...
//            httpGet.abort();
//        } catch (Exception e) {
//            log.error("HTTP连接时发生异常:{}", e.getMessage());
//        }
////        finally {
...
////                } catch (Exception e) {
////                    log.error("关闭HTTP连接时发生异常:{}", e.getMessage());
////                }
////            }
////        }
//        return returnVal;
...
//        } catch (Exception e) {
//            log.error("createCloseableHttpClient error:{}", e.getMessage());
//        }
...
//                    .build();
//        } catch (Exception e) {
//            log.error("createRegistry error:{}", e.getMessage());
//        }
//        return registry;
//    }
//
